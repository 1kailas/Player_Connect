...
public class CertificateService {
    ...
    public Certificate verifyCertificate(
        ...
        // Notify user
        User user = userRepository
            .findById(certificate.getUserId())
            .orElseThrow(() -> new RuntimeException("User not found"));
    ...
    @Transactional
    public Certificate rejectCertificate(
        String certificateId,
        String adminId,
        String reason
    ) {
    ...
    public Page<Certificate> getAllCertificates(
        Boolean verified,
        CertificateType type,
        Pageable pageable
    ) {
        if (verified != null && type != null) {
            return certificateRepository.findByVerifiedAndCertificateType(
                verified,
                type,
                pageable
            );
    ...
    public void deleteCertificate(String certificateId) {
        ...
        User user = userRepository
            .findById(certificate.getUserId())
            .orElse(null);
        if (user != null && user.getCertificateIds() != null) {
